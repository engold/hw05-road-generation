...
class ShaderProgram {
  ...
  //added for hw5
  unifSlider: WebGLUniformLocation;
  ...
  constructor(shaders: Array<Shader>) {
    ...
    this.unifSlider      = gl.getUniformLocation(this.prog, "u_Slider");// for hw5 to pass slider value
...
// added for hw5
  setSliderVar(t: number) {
    this.use();
    if (this.unifSlider !== -1) {
      gl.uniform1f(this.unifSlider, t);
    }
  }
